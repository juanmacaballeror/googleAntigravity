...
// Fuentes embebidas (pdfmake requiere fuentes Roboto)
const fonts = {
  Roboto: {
...
/**
 * Genera la cabecera corporativa compartida por todos los documentos
 */
...
/**
 * Sección de partes (vendedor / comprador / agente)
 */
...
/**
 * Genera un PDF en base al tipo de contrato
 * @param {object} contrato - Datos del contrato + propiedad + cliente
